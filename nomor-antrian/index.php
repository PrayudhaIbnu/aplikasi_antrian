        ...
        <div class="col-lg-5 mb-4">
          <div class="px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
            ...
            <div class="d-flex align-items-center me-md-auto">
              <i class="bi-people-fill text-warning me-3 fs-3"></i>
          ...
          <div class="card border-0 shadow-sm">
            <div class="card-body text-center d-grid p-5">
              <div class="border border-warning rounded-2 py-2 mb-5">
                <h3 class="pt-4">ANTRIAN</h3>
                <!-- menampilkan informasi jumlah antrian -->
                <h1 id="antrian" class="display-1 fw-bold text-warning text-center lh-1 pb-2"></h1>
              </div>
              <!-- button pengambilan nomor antrian -->
              <a id="insert" href="javascript:void(0)" class="btn btn-warning btn-block rounded-pill fs-5 px-5 py-4 mb-2">
    ...
    $(document).ready(function() {
      ...
      $('#insert').on('click', function() {
        $.ajax({
          ...
          warning: function(result) {       // ketika proses insert data selesai
            // jika berhasil
            if (result === 'Sukses') {
              // tampilkan jumlah antrian
