    ...
    <div class="container pt-4">
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
        ...
        <div class="d-flex align-items-center me-md-auto">
          <i class="bi-mic-fill text-warning me-3 fs-3"></i>
        ...
        <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
          <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="http://www.indrasatya.com/"><i class="bi-house-fill text-warning"></i></a></li>
        ...
        <div class="col-md-3 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
              <div class="d-flex justify-content-start">
                <div class="feature-icon-3 me-4">
                  <i class="bi-person-check text-warning"></i>
                </div>
                <div>
                  <p id="antrian-sekarang" class="fs-3 text-warning mb-1"></p>
          ...
          },
          {
            ...
            "render": function(data, type, row) {
              ...
              // jika data "status = 0"
                ...
                var btn = "<button class=\"btn btn-warning btn-sm rounded-circle\"><i class=\"bi-mic-fill\"></i></button>";
              } 
              // jika data "status = 1"
